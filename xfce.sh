...
pacman -S --noconfirm "xorg xorg-server xfce4 lightdm lightdm-gtk-greeter lightdm-gtk-greeter-settings fastfetch htop" || error_exit "Failed to install XFCE packages."
